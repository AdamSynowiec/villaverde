        ...
        <Container>
            ...
            <div className='px-4'>
                <div className="text-center">
                    <h1 className='text-center py-4 text-xl'>Polityka prywatności</h1>
                </div>
                <Link to={"/"} className='underline'>Powrót</Link>

                <article className='text-justify'>
                    <div class="">
                        <h2 class="pb-3 pt-12 text-lg"><strong>1. Informacje ogólne</strong></h2>
                        <ol className="list-decimal">
                            <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>villaverde-wola.pl</b></li>
                            <li>Operatorem serwisu oraz Administratorem danych osobowych jest: WOLA JUSTOWSKA INWESTYCJE 3 SP. Z O.O. ul. Koło Strzelnicy 2/2 30-219 Kraków</li>

                            <li>Adres kontaktowy poczty elektronicznej operatora: kontakt@villaverde-wola.pl</li>
                            ...
                            <ul className="list-disc pl-5"><li>Prowadzenie newslettera</li><li>Obsługa zapytań przez formularz</li><li>Realizacja zamówionych usług</li><li>Prezentacja oferty lub informacji</li>
                            </ul>
                        ...
                        <h2 class="pb-3 pt-12 text-lg"><strong>4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</strong></h2>
                        <ol className="list-decimal"><li>W niektórych sytuacjach Administrator ma prawo przekazywać Twoje dane osobowe innym odbiorcom, jeśli będzie to niezbędne do wykonania zawartej z Tobą umowy lub do zrealizowania obowiązków ciążących na Administratorze. Dotyczy to takich grup odbiorców:<ul className="list-disc pl-5"><li>firma hostingowa na zasadzie powierzenia</li><li>upoważnieni pracownicy i współpracownicy, którzy korzystają z danych w celu realizacji celu działania strony</li></ul></li>
                        ...
                        <h2 class="pb-3 pt-12 text-lg"><strong>5. Informacje w formularzach</strong></h2>
                        <ol className="list-decimal">
                        ...
                        <h2 class="pb-3 pt-12 text-lg"><strong>6. Logi Administratora</strong></h2>
                        <ol className="list-decimal">
                        ...
                        <h2 class="pb-3 pt-12 text-lg"><strong>9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</strong></h2>
                        <ol className="list-decimal">
